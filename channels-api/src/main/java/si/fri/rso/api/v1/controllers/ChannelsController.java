...
public class ChannelsController extends MainController {
    ...
    public Response getUserChannels(@PathParam("userId") String userId) {
    ...
    public Response removeUserOnChannel(@PathParam("userId") String userId, @PathParam("channelId") Integer channelId) {
